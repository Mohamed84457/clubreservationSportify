"use client";
//components
import Mycalender from "@/app/components/Calender";
import Slotcatalog from "@/app/components/Slotcatalog";
...
export default function BookingCourt({ params }: PageProps) {
    ...
    <div className="min-h-screen rounded bg-gradient-to-br from-gray-100 via-white to-gray-200 p-4 md:p-8">
      ...
      <div className="max-w-7xl mx-auto mb-10">
        ...
        <div className="mb-3 text-sm text-gray-500 flex items-center gap-2 hidden md:flex">
          <Link href="/website/BrowseCourts" className="hover:text-green-500 transition">
            BrowseCourts
          </Link>
          <span>/</span>
      ...
      <main className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="bg-white lg:col-span-8  rounded-2xl shadow-md p-6 border border-gray-100 hover:shadow-xl transition-shadow">
          <Slots selecteddate={date} typeusing={typeUsingSlots.user} />
        </div>
      </main>
    </div>
  );
